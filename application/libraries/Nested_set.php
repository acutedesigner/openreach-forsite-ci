...
class Nested_set {
	 ...
	 */
	public function setControlParams($table_name, $left_column_name = 'lft', $right_column_name = 'rgt', $primary_key_column_name = 'id', $parent_column_name = 'parent_id', $text_column_name = 'content') {
	...
	function buildCrumbs($crumbData)
	{
		...
		foreach ($crumbData as $itemId)
		{
			...
			$retVal .= '<li>' . anchor(
				...
				array(
					'title' => $itemId[$this->text_column_name])
				);
