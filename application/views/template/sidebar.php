				<aside>
					<?php if(isset($sidebar_articles)): ?>
						...
						<div class="side-list">
							...
							<h3><a href="<?php echo base_url().$article['friendly_title']; ?>"><?php echo $article['title']; ?></a></h3>
						</div>	
					...
					<div class="currentoffers">
						...
						<ul class="right_column">
							...
							<li><a href="<?php echo base_url('current-offers')."/#".$result['id'] ?>"><?php echo $result['title']; ?></a></li>
							<?php endforeach; ?>
						</ul>
					</div>
					<?php endif; ?>
